...
/// @title OEFB NFT
contract OefbNFTAudited is ERC721A, Ownable, Pausable {
    /**
     ...
     */
    uint256 public constant MAX_MINT = 810;
    /**
     ...
     */
    uint16 public mintedReserved; // -> default is already 0
    /**
    ...
    function mintNFT(uint8 amount) external payable {
        ...
        mintedPublic += amount; //always update before
    ...
    */
    function withdrawAll() external onlyOwner {
        payable(msg.sender).transfer(address(this).balance); //don't use transfer - could fail
    }
